...
#define GET_FILE_RECORD_QUERY \
        ...
        "  lock, lockOwnerDisplayName, lockOwnerId, lockType, lockOwnerEditor, lockTime, lockTimeout, isShared, lastShareStateFetchedTimestmap, isMyShare" \
        " FROM metadata" \
...
static void fillFileRecordFromGetQuery(SyncJournalFileRecord &rec, SqlQuery &query)
{
    ...
    rec._isMyShare = query.intValue(21) > 0;
}
...
bool SyncJournalDb::updateMetadataTableStructure()
{
    ...
    addColumn(QStringLiteral("isMyShare"), QStringLiteral("INTEGER"));
...
Result<void, QString> SyncJournalDb::setFileRecord(const SyncJournalFileRecord &_record)
{
    ...
    const auto query = _queryManager.get(PreparedSqlQueryManager::SetFileRecordQuery, QByteArrayLiteral("INSERT OR REPLACE INTO metadata "
                                                                                                        ...
                                                                                                        "lockOwnerEditor, lockTime, lockTimeout, isShared, lastShareStateFetchedTimestmap, isMyShare) "
    ...
    query->bindValue(28, record._isMyShare);
